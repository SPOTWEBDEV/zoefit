...
<div id="modalHolder" class="relative z-10" aria-labelledby="modal-title" role="dialog" aria-modal="true">
  ...
  <div class="mt-10 sm:mx-auto sm:w-full sm:max-w-sm">
    <form class="space-y-6" action="#" method="POST">
      ...
      <div>
        <button style="background:#0A96ADff" type="submit" class="flex w-full justify-center rounded-md  bg-clifford px-3 py-1.5 text-sm  leading-6 text-white shadow-sm hover:bg-indigo-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600">Sign in</button>
      </div>
    </form>

    <p class="mt-10 text-center text-sm text-black">
      Not a member?
      <a href="#"  id="register" class="font-semibold leading-6 text-clifford hover:text-blue-600">create an account now</a>
    </p>
  </div>
</div>
                                             </div>
