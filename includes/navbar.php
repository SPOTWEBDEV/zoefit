    ...
    <div class="relative flex h-16 items-center justify-between">
        ...
        <div class="hidden sm:ml-6 sm:block">
          <div class="flex space-x-4">
            ...
            <div class="relative inline-block text-left">
              <div>
                <button id="options" type="button" class="inline-flex w-full justify-center gap-x-1.5 rounded-md  px-4 py-2 text-sm  text-white     w-full " id="menu-button" aria-expanded="true" aria-haspopup="true">
                  Services
      ...
      <div class="absolute inset-y-0 right-0 flex items-center pr-2 sm:static sm:inset-auto sm:ml-6 sm:pr-0">
        ...
        <div class="relative ml-3">
          <div>
            <button id="options" type="button" class="relative flex rounded-full bg-gray-800 text-sm focus:outline-none focus:ring-2 focus:ring-white focus:ring-offset-2 focus:ring-offset-gray-800" id="user-menu-button" aria-expanded="false" aria-haspopup="true">
              <span class="absolute -inset-1.5"></span>
          ...
          <div id="optionsHolder" class="absolute right-0 z-10 mt-2 w-48 origin-top-right rounded-md bg-white py-1 shadow-lg ring-1 ring-black ring-opacity-5 focus:outline-none" role="menu" aria-orientation="vertical" aria-labelledby="user-menu-button" tabindex="-1">
            ...
            <a href="http://localhost/zoefit/user/profile/" class="block px-4 py-2 text-sm text-gray-700 w-full flex items-center justify-between" role="menuitem" tabindex="-1" id="user-menu-item-0">Your
