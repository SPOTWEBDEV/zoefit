                   ...
                   <div class="mx-auto grid max-w-2xl grid-cols-1 gap-x-8 gap-y-16 sm:gap-y-20 lg:mx-0 lg:max-w-none lg:grid-cols-2">
                            <div class="lg:pr-8 lg:pt-4">
                                     <div class="lg:max-w-lg">
                                              <h2 class="text-base font-semibold leading-7 text-indigo-600">Zoefit</h2>
                                              <p class="mt-2 text-3xl font-bold tracking-tight text-gray-900 sm:text-4xl">Zoefit Buy In Style</p>
                                              <p class="mt-6 text-lg leading-8 text-gray-600">Are you tired of running out of data at the most inconvenient times? Look no further – ZOEFIT is your go-to destination for hassle-free data bundle purchases, ensuring you stay connected whenever and wherever you need it.</p>
 ...
 <div class="bg-white py-24 sm:py-32">
          <div class="mx-auto max-w-7xl px-6 lg:px-8">
                   <div class="mx-auto max-w-2xl lg:text-center">
                            <h2 class="text-2xl leading-7 text-indigo-600">service</h2>
          ...
          <div class="mx-auto max-w-7xl px-6 lg:px-8">
                   ...
                   <div class="mx-auto mt-10 max-w-2xl lg:mx-0 lg:max-w-none">
                            ...
                            <dl class="mt-16 grid grid-cols-1 gap-8 sm:mt-20 sm:grid-cols-2 lg:grid-cols-4">
                                     ...
                                     <div class="flex flex-col-reverse">
                                              <dt class="text-base leading-7 text-gray-300">Revence Per Day</dt>
